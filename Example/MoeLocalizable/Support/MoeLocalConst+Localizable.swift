...
extension MoeLocalConst {
    ...
    /// 邮箱注册
    var title: String { get { return localized("title", "邮箱注册") } }
    /// 请输入用户名
    var username: String { get { return localized("username", "请输入用户名") } }
    /// 请输入登录密码
    var password: String { get { return localized("password", "请输入登录密码") } }
    /// 请输入交易密码
    var transaction: String { get { return localized("transaction", "请输入交易密码") } }
    /// 请输入邮箱
    var email: String { get { return localized("email", "请输入邮箱") } }
    /// 请输入邀请码
