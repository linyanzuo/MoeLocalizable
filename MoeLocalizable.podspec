...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MoeLocalizable.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/linyanzuo1222@gmail.com/MoeLocalizable'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'linyanzuo1222@gmail.com' => 'zed@moemoetech.com' }
  s.source           = { :git => 'https://github.com/linyanzuo1222@gmail.com/MoeLocalizable.git', :tag => s.version.to_s }
